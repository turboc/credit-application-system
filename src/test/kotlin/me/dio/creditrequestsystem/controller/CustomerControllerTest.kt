...
class CustomerControllerTest {
    ...
    fun `should create a customer and return 201 status`() {
        // given
        val customerDto: CustomerDto = BuildUtil.buildCustomerDto()
        val valuesAsString: String = objectMapper.writeValueAsString(customerDto)
        ...
        mockMvc.perform(MockMvcRequestBuilders.post(URL)
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.lastName").value("V"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.cpf").value("88358271670"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.email").value("jorge@email.com"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.income").value("1000.0"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.zipCode").value("12345"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.street").value("Marechal"))
    ...
    fun `should not save a customer with same CPF and return 409 status`() {
        //given
        customerRepository.save(BuildUtil.buildCustomerDto().toEntity())
        val customerDto: CustomerDto = BuildUtil.buildCustomerDto()
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.title").value("409 CONFLICT! Consult the documentation"))
    ...
    fun `should not save a customer with empty firstName and return 400 status`() {
        //given
        val customerDto: CustomerDto = BuildUtil.buildCustomerDto(firstName = "")
        val valueAsString: String = objectMapper.writeValueAsString(customerDto)
        //when
        //then
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.jsonPath("$.title").value("400 BAD_REQUEST! Consult the documentation"))
            .andExpect(MockMvcResultMatchers.jsonPath("$.timestamp").exists())
    ...
    fun `should find customer by id and return 200 status`() {
        //given
        val customer: Customer = customerRepository.save(BuildUtil.buildCustomerDto().toEntity())
        //when
        //then
        mockMvc.perform(
    ...
    fun `should update a customer and return 200 status`() {
        //given
        val customer: Customer = customerRepository.save(BuildUtil.buildCustomerDto().toEntity())
        val customerUpdateDto: CustomerUpdateDto = BuildUtil.buildCustomerUpdateDto()
        ...
        mockMvc.perform(
            ...
            .andExpect(MockMvcResultMatchers.status().isOk)
            .andExpect(MockMvcResultMatchers.jsonPath("$.firstName").value("Jorge-Update"))
